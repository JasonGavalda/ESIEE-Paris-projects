...
import sys
path = "D:\ESIEE\E5\Info\P2\DSIA-5202C\TP/"  # chemin vers un répertoire temporaire
...
filename = path+"02 Ex\_02 Ex 4 tensor.data"
...
def Ex11() :
    ...
    T2 = T1[2]
    T2= 0.3 * T1[2,0,:,:] + 0.59 * T1[2,1,:,:] + 0.11 * T1[2,2,:,:]
    ShowTensorImg(T2)
