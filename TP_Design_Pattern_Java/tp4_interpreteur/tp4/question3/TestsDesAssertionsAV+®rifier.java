...
public class TestsDesAssertionsAVérifier extends junit.framework.TestCase{
    ...
    VisiteurInstruction<String> vs = new VisiteurInstToString(ves,vbs);
  	...
  	Instruction i = new Assertion(new Egal(x,new Constante(6)));
 	  try{
 	    i.accepter(vi);
 	    fail("attention, " + i.accepter(vs) + " est sans effet ???, installer l'option \"-ea\" ligne 480 de bluej.defs soit bluej.vm.args=-ea ");
 	  }catch(Throwable e){
